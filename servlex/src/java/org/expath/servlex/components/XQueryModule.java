...
{
    public XQueryModule(SaxonRepository repo, String uri)
    {
        myRepo = repo;
        myUri  = uri;
    }
    ...
    /** The logger. */
    private static final Logger LOG = Logger.getLogger(XQueryModule.class);

    /** The package repository where to resolve the query URI. */
